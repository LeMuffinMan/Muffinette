...
# recipes "--leaks" "-r" "export HO\`LA=bonjour" // es ` ne sont pas a gerer 
...
echo 
recipes "--leaks" "touch test test1 test2 test3 salut test4 coucou test5" "mkdir dir_test1 dir_test2 dir_test3" "echo *dir"
recipes "--leaks" "touch test test1 test2 test3 salut test4 coucou test5" "mkdir dir_test1 dir_test2 dir_test3" "echo *1"
recipes "--leaks" "touch test test1 test2 test3 salut test4 coucou test5" "mkdir dir_test1 dir_test2 dir_test3" "echo te*3"
recipes "--leaks" "echo *" 
# recipes "--leaks" "echo *." 
recipes "--leaks" "export a= b=hey c= d=\" ca va\"" "echo \$a\$b\$c\$d" 
recipes "--leaks" "export a= b=hey c= d=\" ca va\" && echo \$a\$b\$c\$d" 
recipes "--leaks" "export a=ls" "\$a" 
# recipes "--leaks" "export a=|<>" "\$a" 
recipes "--leaks" "export a=\"whoami | cat -e\"" "echo \$a" "\$a" 
echo 
echo -e "${YELLOW}basics$NC"
echo 
recipes "--leaks" "echo \$" 
...
echo 
recipes "--leaks" "cmd_not_found" "echo \$?" 
recipes "--leaks" "cmd_not_found || echo \$?" 
recipes "--leaks" "/usr/bin/sudo " "echo \$?" 
recipes "--leaks" "/usr/bin/sudo || echo \$?" 
recipes "--leaks" " " 
recipes "--leaks" "echo 'a''b'" 
recipes "--leaks" "export=|><" 
recipes "--leaks" "echo \$test\"jrjr\"" 
recipes "--leaks" "export test=" "echo \$test anything" 
recipes "--leaks" "ls > out error_to_print_for_this_arg" 
recipes "--leaks" "ls|ls" 
recipes "--leaks" "-r" "echo>log/outfile" 
recipes "--leaks" "-r" "echo \"'\$USER'\"" 
recipes "--leaks" "-r" "ls < > log/outfile" 
recipes "--leaks" "/////////ls" 
recipes "--leaks" "minishell" 
recipes "--leaks" "/" 
recipes "--leaks" "/./../../../../.." 
recipes "--leaks" "-" 
recipes "--leaks" "\"\"''echo hola\"\"'''' que\"\"'' tal\"\"''" 
recipes "--leaks" "echo \$? | echo \$? | echo \$?" 
recipes "--leaks" "echo > <" 
recipes "--leaks" "echo | |" 
recipes "--leaks" "echo \$*" 
recipes "--leaks" "echo '\$''''" 
recipes "--leaks" "echo \"\$HO\"ME" 
recipes "--leaks" "echo \"\$HO\"\"ME\"" 
recipes "--leaks" "echo \"'\$HO''ME'\"" 
recipes "--leaks" "echo hola\"\"\"\"\"\"\"\"\"\"\"\"" 
recipes "--leaks" "echo hola''''''''''''" 
recipes "--leaks" "e\"cho hola\"" 
recipes "--leaks" "echo \"hola     \" | cat -e" 
recipes "--leaks" "\"e\"'c'ho 'b'\"o\"nj\"o\"'u'r" 
recipes "--leaks" "\"\"e\"'c'ho 'b'\"o\"nj\"o\"'u'r\"" 
recipes "--leaks" "echo \"\$DONTEXIST\"Makefile" 
recipes "--leaks" "\$?" 
recipes "--leaks" "\$?\$?" 
recipes "--leaks" "?\$HOME" 
...
# recipes "--leaks" "./minishell" 
recipes "--leaks" "echo \$?\$" 
# recipes "--leaks" "echo \$:\$= | cat -e" 
# recipes "--leaks" "echo \" \$ \" | cat -e" 
recipes "--leaks" "echo '*'" 
recipes "--leaks" "echo *" 
recipes "--leaks" "echo t*" 
recipes "--leaks" "echo \$hola*" 
recipes "--leaks" "echo hola*hola *" 
# recipes "--leaks" "echo \$HOME *" 
recipes "--leaks" "echo \$\"HOME\"" 
recipes "--leaks" "echo \$''HOME" 
...
recipes "--leaks" "\$HOME" 
recipes "--leaks" "mkdir a && cd a && mkdir b && cd b && mkdir c && cd c" "cd ../../../ && rm -rf a" 
recipes "--leaks" "*" 
