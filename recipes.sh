...
echo -e "$YELLOW minishell: export: \`/home/oelleaumoelleaum\': not a valid identifier $NC"
recipes "--leaks" "export A=\"\" B= C=\"\$HOME\$USER\"" "export | grep A" "export | grep B" "export | grep C"
...
echo 
echo -e "${YELLOW}A fix apres le fix du cd .. : le pwd part en steak complet$NC" 
...
recipes "--leaks" "echo > /home/muffin/.file" 
recipes "--leaks" "." 
recipes "--leaks" ".." 
recipes "--leaks" "../.." 
recipes "--leaks" "../../" 
...
# recipes "--leaks" "export VAR=VAR @=lol VAR1=VAR1" 
# recipes "--leaks" "export VAR=VAR @=lol VAR1=VAR1 @=lolilol" 
# recipes "--leaks" "export VAR=\"echo hi | sleep 3\"" "export | grep VAR" 
